...
def test_get_summary_quarterly_subscription(client, app):
    ...
    mock_patterns = [
        create_test_pattern("Costco Membership", 60.00, cadence="quarterly", confidence=0.88, occurrences=2),
    ]
...
def test_get_summary_with_income(client, app):
    ...
    mock_patterns = [
        create_test_pattern("Netflix", 15.99, confidence=0.95),
        create_test_pattern("Employer Direct Deposit", -2000.00, cadence="biweekly", confidence=0.98, occurrences=20),
    ]
